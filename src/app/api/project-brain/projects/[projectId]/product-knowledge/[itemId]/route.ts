...
export async function GET(_request: Request, { params }: RouteContext) {
  try {
    return apiSuccess(await getKnowledge("product", params.projectId, params.itemId));
  } catch (error) {
...
export async function PATCH(request: Request, { params }: RouteContext) {
  ...
  try {
    return apiSuccess(await updateKnowledge("product", params.projectId, params.itemId, parsed.data));
  } catch (error) {
    return handleProjectBrainError(error);
  }
}
...
export async function DELETE(_request: Request, { params }: RouteContext) {
  try {
    return apiSuccess(await deleteKnowledge("product", params.projectId, params.itemId));
  } catch (error) {
    return handleProjectBrainError(error);
  }
}
